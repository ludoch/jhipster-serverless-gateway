package serverless.gateway.repository;

import serverless.gateway.JhipsterServerlessGatewauApp;
import serverless.gateway.config.Constants;
import serverless.gateway.config.audit.AuditEventConverter;
import serverless.gateway.domain.PersistentAuditEvent;
...
import static serverless.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
