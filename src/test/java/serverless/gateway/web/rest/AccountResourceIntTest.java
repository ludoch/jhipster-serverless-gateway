package serverless.gateway.web.rest;

import serverless.gateway.JhipsterServerlessGatewauApp;
import serverless.gateway.config.Constants;
import serverless.gateway.domain.Authority;
import serverless.gateway.domain.User;
import serverless.gateway.repository.AuthorityRepository;
import serverless.gateway.repository.UserRepository;
import serverless.gateway.security.AuthoritiesConstants;
import serverless.gateway.service.MailService;
import serverless.gateway.service.UserService;
import serverless.gateway.service.dto.PasswordChangeDTO;
import serverless.gateway.service.dto.UserDTO;
import serverless.gateway.web.rest.errors.ExceptionTranslator;
import serverless.gateway.web.rest.vm.KeyAndPasswordVM;
import serverless.gateway.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = JhipsterServerlessGatewauApp.class)
